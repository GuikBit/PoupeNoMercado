/**
 * Construção do bundle de export, no formato de fixtures de docs/02 §9:
 *
 ...
 *
 * Módulo PURO, sem import de módulo nativo: roda em node (scripts) e em Jest.
 * A escrita em disco e o compartilhamento ficam em `export.ts`.
 */
